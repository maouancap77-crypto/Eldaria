...
export const ITEMS: Record<string, ItemDef> = {
  ...
  bow: { id: 'bow', name: 'Arco Curto', category: 'weapon', desc: 'Flechas velozes à distância. Dano 14.', sprite: 'wpn_bow', max: 1, damage: 14, attackSpeed: 1.8, reach: 340, arc: 0, rarity: 'uncommon' },
...
export const CLASSES: Record<string, HeroClassDef> = {
  ...
  archer: {
    ...
    startWeapon: 'bow',
    startItems: [{ id: 'berry', qty: 3 }, { id: 'fiber', qty: 3 }],
